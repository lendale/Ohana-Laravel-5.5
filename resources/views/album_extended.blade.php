...
<main>
    <section class="select container">
        ...
        <div id="section">
            <a type="button" onclick="getExtendedAlbumList()" class="btn btn-danger btn-sm" data-toggle="modal" title="Upload Photo" data-target="#uploadModal">Upload Photo</a>

            <a type="button" class="btn btn-danger btn-sm" data-toggle="modal" title="Create Album" data-target="#createAlbumCoverModal">Create Extended Album<br></a>
</div>
            <div class="col-md-12">
                <div class="container">
                    <center>
				...
				<div class="row">
                    ...
                    <h4>Share Album With:</h4>
                        ...
                        <!-- <div class="form-group"> -->
                            ...
                            <div class="form-check form-check-radio form-check-inline">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="album_privacy" id="album_privacy" value="Extended Family" checked="checked">Extended Family
                                    <span class="circle">
                                        <span class="check"></span>
                                    </span>
                                </label>
...
<!-- USER ALBUM JS -->
<script src="assets/js/album_extended.js"></script>
