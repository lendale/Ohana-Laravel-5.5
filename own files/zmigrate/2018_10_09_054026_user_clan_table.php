...
class UserClanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_clan', function (Blueprint $table) {
            $table->integer('uid');
            $table->integer('pid');
            ...
            $table->foreign('key')->references('pid')->on('user_potential');
        });
    }
